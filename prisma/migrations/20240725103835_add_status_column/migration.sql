/*
  ...
  - Added the required column `Enabled` to the `ApiEntity` table without a default value. This is not possible if the table is not empty.
  - Added the required column `Hits` to the `ApiEntity` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_ApiEntity" ("Database_id", "Datasource_id", "Display", "Id", "Name", "Table_id") SELECT "Database_id", "Datasource_id", "Display", "Id", "Name", "Table_id" FROM "ApiEntity";
