/*
  ...
  - Added the required column `ShareString` to the `Form` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Form" ("Enabled", "Id", "Name", "Title", "UserId", "dataSourceId") SELECT "Enabled", "Id", "Name", "Title", "UserId", "dataSourceId" FROM "Form";
DROP TABLE "Form";
